...
def Story4(debug = True):
    ...
    deviceName1 = getDeviceName1 ("Enter the name of the device this person would play these games on (or just choose one if device support varies): ", debug)
    ...
    out += " decided to take a step back and play " + videoGame3 + " using a " 
    out += nonGamingItem2 
    out += ". " + ("\n")
